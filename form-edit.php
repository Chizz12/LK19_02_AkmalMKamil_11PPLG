...
<body>
    <form action="proses-edit.php" method="POST">
        ...
        <p>
            ...
            <label><input type="radio" name="jenis_kelamin" value="lainnya" <?php echo ($jk == 'lainnya') ? "checked": "" ?>>Lainnya</label>
        </p>
        <p>
            <label for="jurusan">jurusan: </label>
            <?php $jurusan = $siswa['jurusan']; ?>
            <select name="jurusan">
                <option <?php echo ($jurusan == 'AKL') ? "selected": "" ?>>AKL</option>
                <option <?php echo ($jurusan == 'TKJ') ? "selected": "" ?>>OTKP</option>
                <option <?php echo ($jurusan == 'TB') ? "selected": "" ?>>TB</option>
                <option <?php echo ($jurusan == 'DKV') ? "selected": "" ?>>DKV</option>
                <option <?php echo ($jurusan == 'PPLG') ? "selected": "" ?>>PPLG</option>
            </select>
        </p>
        <p>
